...
object RenameData {
  ...
  def dataRenamed(data_rename:DataFrame): DataFrame = {
    ...
    data_rename.select($"payload.*", $"payload")
      ...
      .withColumn("issueDate", HelperFunctions.getTimestampWithMilisUDF($"issueDate", lit("yyyy-MM-dd'T'HH:mm:ss.SSSZ")))
      .withColumn("inceptionDate", HelperFunctions.getTimestampWithMilisUDF($"inceptionDate", lit("yyyy-MM-dd'T'HH:mm:ss.SSSZ")))
      .withColumn("effectiveEndDate", HelperFunctions.getTimestampWithMilisUDF($"effectiveEndDate", lit("yyyy-MM-dd'T'HH:mm:ss.SSSZ")))
      .withColumn("transactionDate", HelperFunctions.getTimestampWithMilisUDF($"transactionDate", lit("yyyy-MM-dd'T'HH:mm:ss.SSSZ")))
      .withColumn("sysTxDateStamp", HelperFunctions.getTimestampWithMilisUDF($"sysTxDateStamp", lit("yyyy-MM-dd'T'HH:mm:ss.SSSZ")))
      ...
      .withColumn("f_name", HelperFunctions.myFileName(input_file_name()))
